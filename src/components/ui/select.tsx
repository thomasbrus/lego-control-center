"use client";
import { Portal, type Assign, type SelectRootProps } from "@ark-ui/react";
...
export const ItemIndicator = forwardRef<HTMLDivElement, HTMLStyledProps<"div">>(function ItemIndicator(props, ref) {
...
export type DefaultProps<T> = RootProps<T> & { label?: string; children: React.ReactNode };

export function Default<T>({ label, collection, children, ...props }: DefaultProps<T>) {
  return (
