...
interface UseBluetoothReturn {
  ...
  error: string | null;
  requestDevice: (options?: RequestDeviceOptions) => Promise<BluetoothDeviceInfo | null>;
  connect: () => Promise<boolean>;
  disconnect: () => Promise<void>;
  readCharacteristic: (serviceUuid: BluetoothServiceUUID, characteristicUuid: BluetoothServiceUUID) => Promise<DataView | null>;
  writeCharacteristic: (
  ...
  stopNotifications: (serviceUuid: BluetoothServiceUUID, characteristicUuid: BluetoothServiceUUID) => Promise<boolean>;
}
...
export const useBluetooth = (options: UseBluetoothOptions = {}): UseBluetoothReturn => {
  ...
  const requestDevice = useCallback(
    async (requestOptions?: RequestDeviceOptions): Promise<BluetoothDeviceInfo | null> => {
      ...
      try {
        ...
        let deviceOptions: RequestDeviceOptions;

        if (requestOptions) {
          deviceOptions = requestOptions;
  ...
  const getCharacteristic = useCallback(
    async (serviceUuid: BluetoothServiceUUID, characteristicUuid: BluetoothServiceUUID): Promise<any | null> => {
      ...
      try {
        ...
        const errorMessage = err instanceof Error ? err.message : "Failed to get characteristic";
        setError(errorMessage);
        return null;
      }
    },
  ...
  const readCharacteristic = useCallback(
    async (serviceUuid: BluetoothServiceUUID, characteristicUuid: BluetoothServiceUUID): Promise<DataView | null> => {
      ...
      try {
        ...
        const errorMessage = err instanceof Error ? err.message : "Failed to read characteristic";
        setError(errorMessage);
        return null;
      }
    },
  ...
  const writeCharacteristic = useCallback(
    async (serviceUuid: BluetoothServiceUUID, characteristicUuid: BluetoothServiceUUID, value: BufferSource): Promise<boolean> => {
      const characteristic = await getCharacteristic(serviceUuid, characteristicUuid);
      ...
      try {
        ...
        const errorMessage = err instanceof Error ? err.message : "Failed to write characteristic";
        setError(errorMessage);
        return false;
      }
    },
  ...
  const startNotifications = useCallback(
    async (
      ...
      try {
        ...
        const errorMessage = err instanceof Error ? err.message : "Failed to start notifications";
        setError(errorMessage);
        return false;
      }
    },
  ...
  const stopNotifications = useCallback(
    async (serviceUuid: BluetoothServiceUUID, characteristicUuid: BluetoothServiceUUID): Promise<boolean> => {
      const characteristic = await getCharacteristic(serviceUuid, characteristicUuid);
      if (!characteristic) return false;
      ...
      try {
        ...
        const errorMessage = err instanceof Error ? err.message : "Failed to stop notifications";
        setError(errorMessage);
        return false;
      }
    },
